...
__attribute__((noinline, used)) int target_add(int a, int b) {
...
__attribute__((noinline, used)) static int hook_mul(int a, int b) {
...
static void test_basic_hook(void) {
  ...
  orig_add = NULL;
  int n = syringe_hook_install_addr("target_add", (void *)target_add, (void *)hook_mul, (void **)&orig_add);
...
static void test_edge_cases(void) {
  ...
  orig_add = NULL;
  int n1 = syringe_hook_install_addr("target_add", (void *)target_add, (void *)hook_mul, (void **)&orig_add);
  ASSERT_EQ(1, n1, "first install OK");

  /* Duplicate install must be rejected */
  add_fn orig2 = NULL;
  int n2 = syringe_hook_install_addr("target_add", (void *)target_add, (void *)hook_mul, (void **)&orig2);
  ...
  orig_add = NULL;
  int n3 = syringe_hook_install_addr("target_add", (void *)target_add, (void *)hook_mul, (void **)&orig_add);
...
static void test_is_installed(void) {
  ...
  ASSERT_EQ(0, syringe_hook_is_installed("target_add"), "not installed initially");

  orig_add = NULL;
  syringe_hook_install_addr("target_add", (void *)target_add, (void *)hook_mul, (void **)&orig_add);
  ASSERT_EQ(1, syringe_hook_is_installed("target_add"), "installed after install_addr");

  syringe_hook_remove_all();
  ASSERT_EQ(0, syringe_hook_is_installed("target_add"), "not installed after remove_all");
}
