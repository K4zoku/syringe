...
static const CLSID CLSID_SyringeProfiler = {
    0x0c1c6cb5, 0x3ac9, 0x4338, {0x8e, 0x16, 0x42, 0xa0, 0xdc, 0x8b, 0x34, 0xf1}};
...
interface ICorProfilerCallback : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE MovedReferences(uint32_t cMovedObjectID, void *oldObjectID[],
                                                    void *newObjectID[]) = 0;
  virtual HRESULT STDMETHODCALLTYPE ObjectAllocated(void *objectID, void *classId) = 0;
  virtual HRESULT STDMETHODCALLTYPE ObjectsAllocatedByClass(uint32_t cClassCount, uint32_t classIDs[],
                                                            uint32_t cObjects[]) = 0;
  virtual HRESULT STDMETHODCALLTYPE ObjectReferences(void *objectId, void *classId, uint32_t cObjectRefs,
                                                     void *objectRefIds[]) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE COMClassicVTableCreated(void *managedId, void *classId, void *interfaceId,
                                                            void *vTable, uint32_t cSlot) = 0;
...
interface ICorProfilerCallback2 : public ICorProfilerCallback {
  ...
  virtual HRESULT STDMETHODCALLTYPE GarbageCollectionStarted(int cGenerations, BOOL generationCollected[],
                                                             uint32_t reason) = 0;
  virtual HRESULT STDMETHODCALLTYPE SurvivingReferences(uint32_t cSurvivingObjectID, void *objectIDRangeStart[],
                                                        uint32_t cObjectIDRangeLength[]) = 0;
  virtual HRESULT STDMETHODCALLTYPE FinalizeableObjectQueued(uint32_t finalizerFlags, void *objectID) = 0;
  virtual HRESULT STDMETHODCALLTYPE RootReferences2(uint32_t cRootRefs, void *rootRefIds[], uint32_t rootKinds[],
                                                    void *rootIds[]) = 0;
...
interface ICorProfilerCallback3 : public ICorProfilerCallback2 {
  virtual HRESULT STDMETHODCALLTYPE InitializeForAttach(IUnknown * pCorProfilerInfoUnk, void *pvClientData,
