...
unsigned long syringe_arch_entry_skip(void) { return 0; /* riscv has no ptrace restart quirk */ }

unsigned int syringe_arch_jump_slot_type(void) { return 0; /* R_RISCV_JUMP_SLOT — fill in when implementing */ }

unsigned int syringe_arch_glob_dat_type(void) { return 0; /* R_RISCV_64 — fill in when implementing */ }
